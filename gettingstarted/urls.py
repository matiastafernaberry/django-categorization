...
urlpatterns = [
    ...
    path(".well-known/pki-validation/3B7A9D37194721F16B7EB9BDC026D751.txt", TemplateView.as_view(template_name='3B7A9D37194721F16B7EB9BDC026D751.txt',content_type='text/plain')),
