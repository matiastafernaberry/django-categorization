...
jQuery(document).ready(function() {
    function getData(namFile, element){
        //console.log('load');
        ...
        request.done(function( msg ) {
            ...
            for (i = 0; i < byCont.length; i++) {
                ...
                if (!sentence){
                    sentence = byCont[i]["Opening Text"];
                }
            ...
            element.parentNode.insertBefore(divInput, element);
        });
    ...
    var elementFile = document.getElementById("div-data-buzztrackerjson");
    namFile = elementFile.getAttribute('class');
    getData(namFile, elementFile);
    //var elementFile2 = document.getElementById("div-data-buzztrackerjson2");
    //if (elementFile2 !== 'undefined'){
    //    namFile2 = elementFile2.getAttribute('class');
    //    getData(namFile2, elementFile2);
    //}
});
</script>