...
class SendEmailClass(View):
	def post(self, request):
		...
		content += "<tr><td style='padding:10px;font-weight:700;'>Direccion web empresa: {0}</td></tr></table>".format(dataPost['direccion_empresa'])
		content += "<tr><td style='padding:10px;font-weight:700;'>Datos usuario: {0}</td></tr></table>".format(dataPost['datoUser'])
